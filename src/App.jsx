      ...
      <div className="group relative bg-gradient-to-br from-gray-700/50 to-gray-800 backdrop-blur-sm border border-gray-600/30 rounded-2xl p-8 hover:border-primary-400/50 transition-all duration-500 animate-scale-in" style={{ animationDelay: "0.1s" }}>
        ...
        <div className="relative z-10">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-center space-x-3">
              <span className="w-2 h-2 bg-blue-400 rounded-full"></span>
              <span className="text-gray-300 font-medium">TypeScript & JavaScript</span>
            </li>
            <li className="flex items-center space-x-3">
              <span className="w-2 h-2 bg-blue-400 rounded-full"></span>
            ...
            <li className="flex items-center space-x-3">
              <span className="w-2 h-2 bg-blue-400 rounded-full"></span>
              <span className="text-gray-300 font-medium">Responsive Design & Accessibilité</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="group relative bg-gradient-to-br from-gray-700/50 to-gray-800 backdrop-blur-sm border border-gray-600/30 rounded-2xl p-8 hover:border-primary-400/50 transition-all duration-500 animate-scale-in" style={{ animationDelay: "0.2s" }}>
        ...
        <div className="relative z-10">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-center space-x-3">
              <span className="w-2 h-2 bg-green-400 rounded-full"></span>
              <span className="text-gray-300 font-medium">Python & C# & Java</span>
            </li>
            <li className="flex items-center space-x-3">
              <span className="w-2 h-2 bg-green-400 rounded-full"></span>
              <span className="text-gray-300 font-medium">MySQL & MongoDB & Neo4j</span>
            </li>
            <li className="flex items-center space-x-3">
              <span className="w-2 h-2 bg-green-400 rounded-full"></span>
              <span className="text-gray-300 font-medium">Domain Driven Design & Architecture Hexagonale</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="group relative bg-gradient-to-br from-gray-700/50 to-gray-800 backdrop-blur-sm border border-gray-600/30 rounded-2xl p-8 hover:border-primary-400/50 transition-all duration-500 animate-scale-in" style={{ animationDelay: "0.3s" }}>
        ...
        <div className="relative z-10">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-center space-x-3">
              <span className="w-2 h-2 bg-orange-400 rounded-full"></span>
              <span className="text-gray-300 font-medium">CI/CD Pipelines (Vercel)</span>
            </li>
            <li className="flex items-center space-x-3">
              <span className="w-2 h-2 bg-orange-400 rounded-full"></span>
              <span className="text-gray-300 font-medium">Docker (bases)</span>
            </li>
            <li className="flex items-center space-x-3">
              <span className="w-2 h-2 bg-orange-400 rounded-full"></span>
              <span className="text-gray-300 font-medium">Linux, Mac & Windows</span>
            </li>
          </ul>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-400 leading-relaxed">
                  ...
                  technologies, je crée des solutions innovantes qui
                  allient performance, design et expérience utilisateur.
                </p>

                <p className="text-lg text-gray-400 leading-relaxed">
                  Mon approche allie créativité et rigueur
                   pour livrer des projets qui dépassent les
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm mt-1">
                          Alternance de 1 an durant ma 3ème année de BUT Informatique. J'ai pu y développer mes compétences en PHP, MySQL, HTML, CSS, JavaScript, découvrir l'architecture hexagonale et le Domain Driven Design.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <div className="flex space-x-4 mt-2">
                        <a target="_blank" rel="noopener noreferrer" href="https://fr.linkedin.com/in/lucas-fanner-181506216" className="social-link">
                          <svg
                            className="w-6 h-6"
                            fill="currentColor"
                            viewBox="0 0 24 24"
                        ...
                        <a target="_blank" rel="noopener noreferrer" href="https://github.com/xentee" className="social-link">
                          <svg
                            className="w-6 h-6"
                            fill="currentColor"
                            viewBox="0 0 24 24"
